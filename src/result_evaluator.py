...
class ResultEvaluator:
    ...
    <html>
    <head>
        <title>All Papers - Reproducibility Visualizations</title>
        <style>
    ...
    <body>
        <h1>📊 All Papers: Reproducibility Visualizations</h1>
        <div class="paper-list">
            {''.join([
                f'<div class="paper-entry">'
                f'<h2>{d.name}</h2>'
                f'<a href="{d.name}/visualizations.html">View Visualizations</a>'
