...
def main():
    ...
    print("\033[1;96m│\033[0m" + "   1. Review outputs/visualizations/visualizations.html in browser".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m│\033[0m" + "   2. Check outputs/reproduction_results.txt for detailed report".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m│\033[0m" + "   3. Analyze outputs/visualizations/detailed_comparison.csv for metrics".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m│\033[0m" + "   4. Read LLM insights and recommendations in the conclusions".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m│\033[0m" + "   5. Use findings to improve experiment reproducibility".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m│\033[0m" + " ".ljust(98) + "\033[1;96m│\033[0m")
    print("\033[1;96m└" + "─" * 98 + "┘\033[0m")
    ...
    try:
        ...
        print("  • Detailed report: \033[1;93m./outputs/reproduction_results.txt\033[0m")
